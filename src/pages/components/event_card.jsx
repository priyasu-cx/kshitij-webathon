...
const EventCard = ({ event }) => {
    ...
    return(
        <div class="flex flex-col items-center py-4 pl-4 mb-4 bg-white border rounded-lg shadow-md md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
            <img
